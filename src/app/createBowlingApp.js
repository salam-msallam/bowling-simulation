...
import { createRenderSettings, PIN_FALL_SOUND_COOLDOWN_MS, SOUND_PATHS } from '/src/config/simulationConfig.js'
import { createLighting, configureShadowLight } from '/src/scene/createLighting.js'
